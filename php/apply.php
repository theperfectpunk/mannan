...
if(trim($name) == '') {
	...
	echo '<div class="error_message">Enter your phone no.</div>';
	exit();
} else if(trim($cletter) == '') {
	echo '<div class="error_message">Enter your message.</div>';
	exit();
} 

if(get_magic_quotes_gpc()) {
	$cletter = stripslashes($cletter);
}
...
//$address = "spb@ezhomz.in";
//$address = "vishal.goyal@mannan.ai,hello@ezhomz.com,sbp@ezhomz.com";
$address = "mohit.tokas@mannan.ai";
